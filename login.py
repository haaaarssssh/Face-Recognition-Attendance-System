...
class Login:
    def __init__(self,root) -> None:
        ...
        name_lbl=Label(self.root,text="Login",font=('Quicksand',36),fg='black',bg='lightblue')
        ...
        student_btn = Button(self.root,text="Student",font=('Quicksand',12),bg="deep sky blue",fg='white', width=40)
